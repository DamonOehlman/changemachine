...
var Item = exports.Item = function(props, state) {
    var item = this;
...
Item.prototype.done = function(nextMachine) {
    // if the item has state, update the machine state
    if (this.state) {
        this.machine.updateState(this.state);
    }
...
Item.prototype.fail = function(err, targetMachine) {
    _leaveMachine(this, 'fail', targetMachine, err);
