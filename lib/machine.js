...
function _fakeStateRetrieve(target, callback) {
    callback();
} // _fakeStateRetrieve
...
function _makeNotifier(machine, target, opts) {
    ...
    if (target) {
        var getState = machine.stateStore ? machine.stateStore.retrieve : _fakeStateRetrieve;

        getState(target, function(state) {
